        ...
        <div class="wrapper"><!-- Header Start -->
            ...
            <div class="contact">
                <div class="container">
                    <div class="row">
                        <div class="col-md-6">
                            <h2 class="section-title">Mantente en contacto</h2>
                            <div class="contact-info">
                                <h3>Información de contacto:</h3>
                                <p>
                                    Encuéntranos en redes sociales y en contactos personales.
                                <h3>Teléfono <span>+52 624 345 6790</span></h3>
                                <h3>E-mail <span>biofactor@gmail.com</span></h3>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="editor-info">
                                <h2 class="section-title">¡Contáctanos ya!</h2>
                                <div class="editor-item">
                                    <div class="editor-img">
                                        <img src="img/icon/editor-1.png" alt="Editor Image">
                                    </div>  
                                    <div class="editor-text">
                                        <h3>General</h3>
                                        <a href="mailto:biofactor@gmail.com">Enviar correo</a>
                                    </div>
                                </div>
                                <div class="editor-item">
                                    <div class="editor-img">
                                    ...
                                    <div class="editor-text">
                                        <h3>Soporte</h3>
                                        <a href="mailto:soportebiofactor@gmail.com">Enviar correo</a>
                                    </div>
                                </div>
                                <div class="editor-item">
                                    <div class="editor-img">
                                    ...
                                    <div class="editor-text">
                                        <h3>Ventas</h3>
                                        <a href="mailto:ventasbiofactor@gmail.com">Enviar correo</a>
                                    </div>
                                </div>
                            </div>
                        </div>
